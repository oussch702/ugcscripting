/*
  ...
  1. New Tables
    ...
    - `team_members` - Detailed team membership management
    - `project_collaborators` - Project-specific permissions
    - `script_comments` - Collaboration and feedback system
...
-- Create additional custom types (only if they don't exist)
DO $$ 
BEGIN
...
-- Profiles policies (with existence checks)
DO $$
BEGIN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'profiles' AND policyname = 'Team members can view team profiles') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'team_members' AND policyname = 'Team owners can manage team members') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'team_members' AND policyname = 'Team members can view team membership') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'team_members' AND policyname = 'Users can view own team membership') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'project_collaborators' AND policyname = 'Project owners can manage collaborators') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'project_collaborators' AND policyname = 'Team leads can manage project collaborators') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'project_collaborators' AND policyname = 'Project collaborators can view project team') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'script_comments' AND policyname = 'Project team can view script comments') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'script_comments' AND policyname = 'Authorized users can create script comments') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'script_comments' AND policyname = 'Comment authors can update their comments') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'script_versions' AND policyname = 'Project team can view script versions') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'script_versions' AND policyname = 'Authorized users can create script versions') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'notifications' AND policyname = 'Authorized users can create notifications') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'performance_data' AND policyname = 'Users can view own performance data') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'performance_data' AND policyname = 'Users can create own performance data') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'performance_data' AND policyname = 'Users can update own performance data') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'performance_data' AND policyname = 'Team leads can view team performance data') THEN
